...
final class LogTicketResolvedActivity implements Listener {
  ...
  public function handle(object $event): void {
    if (! $event instanceof TicketResolved) {
      return;
    }
    ...
    $this->activities->create([
      ...
      'event_type' => ActivityType::TICKET_RESOLVED->value,
      'description' => ActivityType::TICKET_RESOLVED->label() . '.',
    ]);
  }
}
