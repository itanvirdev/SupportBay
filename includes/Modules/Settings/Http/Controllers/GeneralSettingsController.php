...
final class GeneralSettingsController {
  ...
  public function update(WP_REST_Request $request): WP_REST_Response {
    $data=[];
    foreach (['registration_override','disable_registration_form','disable_guest_ticket_creation','client_user_default_role','support_portal_page_id','shortcode_mode','footer_copyright_text','remove_powered_by_branding','wordpress_auth_enabled','wordpress_login_url','wordpress_registration_url','wordpress_profile_enabled','sequential_track_id_enabled','sequential_track_id_prefix','sequential_track_id_length','ticket_list_auto_refresh_enabled','ticket_list_auto_refresh_interval','smart_need_reply_sorting_enabled','dashboard_logo_attachment_id','portal_logo_attachment_id','file_upload_enabled','file_upload_max_size_mb','file_upload_allowed_groups','attachment_popup_preview_enabled','ticket_status_labels','recaptcha_v3_enabled','recaptcha_v3_site_key','recaptcha_v3_secret_key','recaptcha_v3_show_login','recaptcha_v3_show_guest_ticket','recaptcha_v3_show_registration','recaptcha_v3_hide_badge','style_palette','custom_css'] as $key) {
