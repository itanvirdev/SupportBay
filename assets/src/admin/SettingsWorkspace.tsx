...
type SettingsSection = 'categories' | 'tags' | 'sla' | 'saved-replies' | 'notifications' | 'logs' | 'integrations';
...
export function SettingsWorkspace() {
  ...
  return <section className="sbay-settings-workspace">
    ...
    <div>{section === 'categories' ? <CategoryWorkspace /> : section === 'tags' ? <TagWorkspace /> : section === 'sla' ? <TicketSlaWorkspace /> : section === 'saved-replies' ? <SavedReplyWorkspace /> : section === 'notifications' ? <NotificationTemplateWorkspace /> : section === 'logs' ? <NotificationLogWorkspace /> : <ProviderWorkspace />}</div>
  </section>;
}
