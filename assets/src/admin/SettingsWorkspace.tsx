...
type SettingsSection = 'general'|'security'|'roles'|'categories'|'tags'|'custom-fields'|'assign-rules'|'saved-replies'|'notifications'|'weekend'|'auto-close'|'envato'|'lemonsqueezy';
const sections:SettingsSection[]=['general','security','roles','categories','tags','custom-fields','assign-rules','saved-replies','notifications','weekend','auto-close'];
