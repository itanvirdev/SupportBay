...
type SettingsSection = 'sla' | 'saved-replies' | 'notifications' | 'logs' | 'integrations';
...
export function SettingsWorkspace() {
  ...
  return <section className="sbay-settings-workspace">
    ...
    <div>{section === 'sla' ? <TicketSlaWorkspace /> : section === 'saved-replies' ? <SavedReplyWorkspace /> : section === 'notifications' ? <NotificationTemplateWorkspace /> : section === 'logs' ? <NotificationLogWorkspace /> : <ProviderWorkspace />}</div>
  </section>;
}
