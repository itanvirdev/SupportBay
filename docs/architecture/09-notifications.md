...
The Delivery Logs administrator workspace is deferred after MVP. Logs remain an internal implementation detail supporting delivery audit, retries, and retention.
